...
public class Constants {
    ...
    public static int ARM_TRANSITION_POSITION = -23, ARM_HANG_POSITION = 70, ARM_PUT_POSITION = 250, ARM_GRAB_POSITION = 350, ARM_GRAB_POSITION_SAFETY = 325;
    ...
    public static final double InRotPosUp = 0.15, InRotPosMid =0.55, InRotPosDown = 0.95;
