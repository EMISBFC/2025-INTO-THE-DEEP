...
@Autonomous(name = "Right Auto 3 specimen", group = "Autonomous")
public class RightAutoTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action Grab = drive.actionBuilder( new Pose2d(1, -42.5, Math.toRadians(90.00)))
                .strafeTo(new Vector2d(45, -70))
                .build();
